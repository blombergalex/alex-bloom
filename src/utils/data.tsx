...
export const about: AboutMeType = {
  ...
  experience:
    "So far in my journey I've worked with React, TypeScript, Next.js, Node.js, MongoDB, PostgreSQL and CSS frameworks like SASS, Tailwind and Styled Components. I have experience integrating REST API’s, developing unit and integration tests, setting up third party integrations and expanding on existing CMS systems. Team projects taught me the power of Scrum for efficiency, and Git is an essential tool that brings structure and control to my work.",
  nextStep:
    "As my studies are coming to an end, I'm looking forward to the next phase of my career! I am seeking a position in a collaborative team where my eye for detail and ability to quickly learn new technologies are valued, while I continue to grow as a developer. I am based in Stockholm and would enjoy a hybrid workplace where I can combine social interaction at the office with focused work from home while consistently collaborating with my team.",
  purpose: '',
...
export const projects: ProjectType[] = [
  {
    ...
    title: 'Yello',
    date: 'January 2025',
    imgSrc: '/images/yello.png',
    alt: 'Snapshot of Yello',
    description:
      'Yello is my graduation project, the most enjoyable project of my education (apart from it being a solo project and not a team effort)! Built with React, Next.js, Supabase and Google Maps Javascript API to facilitate locating skydivers in the field.',
    githubLink: 'https://github.com/blombergalex/yello',
    websiteLink: 'https://yello-dz.vercel.app/',
    favourite: false,
    techs: [
      'React',
      'Next.js',
    ...
    reportLink:
      'https://drive.google.com/file/d/1J_A-Ew2kt3eyFIP_RjTiPEkjv2RbMAsg/view?usp=drive_link',
  },
  {
    id: uuidv4(),
  ...
  },
  {
    ...
    description:
      "This is my first time working with React. I established an understanding of the core React concepts; functional components, props, and state. I enjoyed learning to store the data in objects and mapping over them to turn them into albums on the user's end.",
  ...
  },
  {
    ...
    description:
      'Jungle Jam marks my first time using data from an external source. The user enters a search of an animal, triggering an API call, and is presented with facts on the requested animal.',
  ...
  },
  {
    ...
    description:
      'Wonderflora is a floral shop where I practiced routing in Express and using EJS templates. Thanks to this project, setting up routes with Next.js feels like a walk in the park compared to routing with Express.',
